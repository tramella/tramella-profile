     ...
     <div className="w-full">
       <div className="w-[80%] mx-auto py-10 flex flex-col justify-start items-start">
         <div className="w-full relative flex justify-start items-end">
           <div className="font-bold text-5xl md:text-6xl">PROJECTS</div>
           <div className="text-xs absolute right-2 top-9 hidden md:block">More  <FontAwesomeIcon icon={faArrowRight}/></div>
         </div>
