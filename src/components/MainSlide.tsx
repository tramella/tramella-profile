    ...
    <div className="w-full">
      <div className="w-[80%] mx-auto py-5">
        <div className="w-full flex flex-col justify-start">
          <div className="w-full text-center text-md font-medium mt-3 md:mt-5">Hi! I'm Tramella</div>
          <div className="w-full text-start text-5xl md:text-8xl font-medium tracking-tighter ">FULLSTACK +</div>
          <div className="w-full grid  grid-cols-1 md:grid-cols-[3fr_5fr] gap-4">
            ...
            <div className="w-full text-end text-5xl md:text-8xl font-medium tracking-tighter">DEVELOPER</div>
            <div className='grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-x-25 gap-y-5'>
               ...
               <div className='w-full flex justify-center md:justify-start h-10'><ContactButton /></div>
            </div>
          </div>
        </div>
      </div>
